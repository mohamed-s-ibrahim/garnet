...
def test_interconnect_unified_buffer_stencil_valid(dw_files, io_sides,
    ...
    configs_mem = [("strg_ub_app_ctrl_input_port_0", 0, 0),
                   ...
                   ("strg_ub_tb_0_range_outer", depth, 0),
                   ("strg_ub_tb_0_starting_addr", 0, 0),
                   ("strg_ub_tb_0_stride", 1, 0),
                   ("strg_ub_tb_0_dimensionality", 1, 0),
                   ("strg_ub_agg_align_0_line_length", depth, 0),
                   ("strg_ub_tb_0_range_inner", 4, 0),
                   ("strg_ub_tb_0_tb_height", 1, 0),
                   ("tile_en", tile_en, 0),
                   ("mode", 0, 0),
                   ("flush_reg_sel", 1, 0),
...
def test_interconnect_line_buffer_unified(dw_files, io_sides, mode):
    ...
    configs_mem = [("strg_ub_app_ctrl_input_port_0", 0, 0),
                   ...
                   ("strg_ub_tb_0_dimensionality", 1, 0),
                   ("strg_ub_agg_align_0_line_length", depth, 0),
                   ("strg_ub_tb_0_indices_merged_0", (0 << 0) | (1 << 3) | (2 << 6) | (3 << 9), 0),
                   ("strg_ub_tb_0_range_inner", 4, 0),
                   ("strg_ub_tb_0_tb_height", 1, 0),
                   ("tile_en", tile_en, 0),
                   ("mode", 0, 0),
...
def test_interconnect_double_buffer_unified(dw_files, io_sides):
    ...
    configs_mem = [("strg_ub_app_ctrl_input_port_0", 0, 0),
                   ...
                   ("strg_ub_tb_0_range_outer", 256, 0),
                   ("strg_ub_tb_0_starting_addr", 0, 0),
                   ("strg_ub_tb_0_stride", 1, 0),
                   ("strg_ub_tb_0_dimensionality", 2, 0),
                   ("strg_ub_tb_0_indices_merged_0", 0, 0),
                   ("strg_ub_tb_0_range_inner", 2, 0),
                   ("strg_ub_tb_0_tb_height", 1, 0),
...
def test_interconnect_double_buffer_alt_weights(dw_files, io_sides):
    ...
    configs_mem = [
        ...
        ("strg_ub_tb_0_range_outer", 256, 0),
        ("strg_ub_tb_0_starting_addr", 0, 0),
        ("strg_ub_tb_0_stride", 0, 0),
        ("strg_ub_tb_0_dimensionality", 2, 0),
        ("strg_ub_agg_align_0_line_length", depth, 0),
        # if dimensionality == 2 version
        ("strg_ub_tb_0_indices_merged_0", (1 << 3) | (0 << 0), 0),
        ("strg_ub_tb_0_range_inner", 2, 0),
