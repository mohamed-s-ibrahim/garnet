...
def test_interconnect_accumulation_buffer(dw_files, io_sides):
    ...
    configs_mem = [("strg_ub_app_ctrl_input_port_0", 1, 0),
                   ("strg_ub_app_ctrl_coarse_input_port_0", 1, 0),
                   ("strg_ub_app_ctrl_output_port_0", 1, 0),
                   ("strg_ub_app_ctrl_coarse_output_port_0", 1, 0),
                   ("strg_ub_app_ctrl_read_depth_0", depth, 0),
                   ("strg_ub_app_ctrl_write_depth_wo_0", depth, 0),
                   ...
                   ("strg_ub_app_ctrl_coarse_write_depth_wo_1", chunk - 1, 0),
...
@pytest.mark.skip
def test_interconnect_chain_accumulation_buffer(dw_files, io_sides):
    chip_size = 2
    interconnect = create_cgra(chip_size, chip_size, io_sides,
                               num_tracks=3,
                               add_pd=True,
    ...
    netlist = {
        "e0": [("I0", "io2f_16"), ("m0", "data_in_0"), ("m1", "data_in_0")],
        "e1": [("m0", "data_out_0"), ("I1", "f2io_16")],
        "e2": [("m1", "data_out_0"), ("I2", "f2io_16")],
        "e3": [("i3", "io2f_1"), ("m0", "wen_in_0"), ("m1", "wen_in_0")],
        "e4": [("i4", "io2f_1"), ("m0", "ren_in_0")],
        "e5": [("i5", "io2f_1"), ("m1", "ren_in_0")],
        "e6": [("m0", "valid_out_0"), ("i4", "f2io_1")],
        "e7": [("m1", "valid_out_0"), ("i5", "f2io_1")]
    }
